...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.hoursPlannedLabelText = QtGui.QLabel(self.tab_2)
        self.hoursPlannedLabelText.setGeometry(QtCore.QRect(340, 190, 191, 17))
        font = QtGui.QFont()
        font.setPointSize(15)
        self.hoursPlannedLabelText.setFont(font)
        self.hoursPlannedLabelText.setObjectName(_fromUtf8("hoursPlannedLabelText"))
        self.plansList = QtGui.QListWidget(self.tab_2)
        self.plansList.setGeometry(QtCore.QRect(30, 20, 181, 241))
        self.plansList.setObjectName(_fromUtf8("plansList"))
        self.newPlanEdit = QtGui.QLineEdit(self.tab_2)
        self.newPlanEdit.setGeometry(QtCore.QRect(242, 70, 191, 27))
        self.newPlanEdit.setObjectName(_fromUtf8("newPlanEdit"))
        self.hoursPlannedLabel = QtGui.QLabel(self.tab_2)
        self.hoursPlannedLabel.setGeometry(QtCore.QRect(290, 190, 51, 17))
        font = QtGui.QFont()
        font.setPointSize(15)
        self.hoursPlannedLabel.setFont(font)
        self.hoursPlannedLabel.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.hoursPlannedLabel.setObjectName(_fromUtf8("hoursPlannedLabel"))
        self.planDelButton = QtGui.QPushButton(self.tab_2)
        self.planDelButton.setGeometry(QtCore.QRect(70, 270, 99, 27))
        self.planDelButton.setObjectName(_fromUtf8("planDelButton"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.hoursPlannedLabelText.setText(_translate("MainWindow", " hours total planned", None))
